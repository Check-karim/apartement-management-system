...
import { z } from "zod";
import { ArrowLeft, Send, Wrench, Building } from "lucide-react";
import toast from "react-hot-toast";
import { Building as BuildingType } from "@/types";

const maintenanceNotificationSchema = z.object({
...
type MaintenanceNotificationFormData = z.infer<typeof maintenanceNotificationSchema>;
...
export default function MaintenanceNotificationsPage() {
  ...
  const {
    ...
    formState: { errors },
    reset,
  } = useForm<MaintenanceNotificationFormData>({
    resolver: zodResolver(maintenanceNotificationSchema),
    defaultValues: {
      priority: "medium",
    },
  });
  ...
  const onSubmit = async (data: MaintenanceNotificationFormData) => {
    try {
      setIsSending(true);
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="px-4 py-4">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">Maintenance Notifications</h1>
              <p className="text-sm text-gray-600">Send maintenance alerts to tenants</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                Leave blank to send to all tenants across all buildings
              </p>
            </div>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g., Scheduled Elevator Maintenance"
                />
                {errors.title && (
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={5}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent text-gray-900 placeholder-gray-500"
                  placeholder="Enter your maintenance notification message..."
                />
                {errors.message && (
